    ...
    <section class="download">
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 mx-auto mb-5">
                <h4 style="font-weight:bold">My Created Researches</h4>
            </div>
...
<?php
                  ...
                  echo "<div><span style='color;grey'>You have not added any research, go</span> <a href='add_research.php' style='color:blue;border-bottom:1px solid blue'>add a research</a></div>";
                }
                ?>
            </div>
        </div>
