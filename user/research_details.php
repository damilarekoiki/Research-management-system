<?php
    ...
    if(!isset($_GET['research_id'])){
        ...
        $research_id=base64_decode($_GET['research_id']);
    ...
    <section class="download">
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 mx-auto mb-5">
                <h4 style="font-weight:bold">Research Details</h4>
            </div>
            
            <div class="col-md-8 mx-auto mb-5" style="margin-top:15px;">
                <?php
                  $i=0;
                  if (!empty($research_details)) {
                    $i++;
                    $research_id=$research_details['research_id'];
                    $title=$research_details['research_title'];
                    $description=$research_details['research_description'];
                    $researcher_id=$research_details['researcher_id'];
                    $is_approved=$research_details['is_approved'];
...
<?php
                  ...
                  echo "<div><span style='color;grey'>No details found for research</span></div>";
                }
                ?>
            </div>
        </div>
