...
$user_id=$_SESSION['user_id'];
  ...
  $tnr=0;
  // $user_surname=$master->get_user_data($user_id)['surname']." ".$master->get_user_data($user_id)['other_names'];
  // $navbar_background="";
  $user_img=$master->get_user_data($user_id)['profile_pix'];
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#" style="color:white;font-size:13px;">About Us</a>
            </li>
            <li class="nav-item">
                <span class="dropdown show">
                  ...
                  <div class="dropdown-menu" araia-labelledby="dropdownMenuButton" style="background:black;">
                    ...
                    if($total_new_follow_requests>0){
                      ?>
                      <a class="nav-link js-scroll-trigger" href="view_all_follow_requests.php" style="font-size:10px;font-weight:bold;color:white;text-decoration:underline"><?php echo $new_follow_notifications;?></a>
                      <?php
                    }else{
                      echo '<a class="nav-link js-scroll-trigger" href="view_all_follow_requests.php" style="font-size:10px;font-weight:bold;color:white;text-decoration:underline">No new follow request, View older</a>';
                    }
                    if($master->get_user_data($user_id)['user_role']==1 && $is_approved_as_coordinator==1){
                      if($total_new_researches>0){
                    ?>
                        <a class="nav-link js-scroll-trigger" href="view_all_researches.php" style="font-size:10px;font-weight:bold;color:white;text-decoration:underline"><?php echo $new_research_notifications;?></a>
                    <?php
                      }else{
                        echo '<a class="nav-link js-scroll-trigger" href="view_all_researches.php" style="font-size:10px;font-weight:bold;color:white;text-decoration:underline">No new created research, View older</a>';
                      }
                    }
                      ?>
                  </div>
