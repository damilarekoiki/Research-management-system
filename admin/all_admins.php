        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
                    $i=0;
                    if(!empty($all_admins)){
                        foreach ($all_admins as $an_admin) {
                            $i++;
                            $admin_id=$an_admin['admin_id'];
                            $profile_pix=$an_admin['profile_pix'];
                            $date_registered=$an_admin['date_registered'];
                            $user_name=$an_admin['surname']." ".$an_admin['other_names'];
                        ...
                        <div class="row" style="margin-top:45px;padding:10px;border-right:1px solid black;border-left:1px solid black;" id="userDiv<?php echo $i;?>">
                            ...
                            <div class="col-md-8 row">
                                ...
                                <div class="col-md-4" style="padding-top:35px">
                                    <span style="color:blue;text-decoration:underline;cursor:pointer" onclick="removeAdmin(<?php echo $admin_id;?>,'userDiv<?php echo $i;?>')">Remove admin</a>
                                </div>
                            </div>
                ...
                <?php
                            // $research->update_an_admin_is_seen($research_id,$follower_id);
                        }
                    }
                ?>
                <!-- </div> -->
...
<script>
        function removeAdmin(AdminId,parentId) {
            
            var formData = new FormData();
            formData.append("remove_admin",1);
