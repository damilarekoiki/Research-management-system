<?php
    ...
    $tot_researches=count($research->get_all_researches());
    $tot_researchers=count($researcher->fetch_all());

    $all_users=$coordinator->fetch_all();
    $tot_coords=count($coordinator->fetch_all());

    $tot_admins=count($admin->fetch_all());
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">Total Researches</h4>
                                <div class="text-center">
                                    <h2 class="font-light m-b-0"><?php echo $tot_researches;?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">Total Researchers</h4>
                                <div class="text-center">
                                    <h2 class="font-light m-b-0"><?php echo $tot_researchers;?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">Total Coordinators</h4>
                                <div class="text-center">
                                    <h2 class="font-light m-b-0"><?php echo $tot_coords;?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">Total Admins</h4>
                                <div class="text-center">
                                    <h2 class="font-light m-b-0"><?php echo $tot_admins;?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-10 mx-auto mb-5">
                        <h4 style="font-weight:bold;">Coordination Role Applications</h4>
                    <?php
                        $i=0;
                        if(!empty($all_users)){
...
<!-- Mirrored from wrappixel.com/demos/admin-templates/monster-admin/main/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Nov 2017 11:16:08 GMT -->
</html>
